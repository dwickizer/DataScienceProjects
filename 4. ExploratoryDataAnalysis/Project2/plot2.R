...
# summarizing the total PM25 emissions for Baltimore City, MD for each year. 
#
...
plot2 <- function() {
    ...
    barplot(height = a, names.arg = b, col = c("blue", "green", "yellow", "red"), 
            density = 100, angle = 45, ylim = c(0,4000), xlab = "Year", ylab = "PM2.5 (Tons)", 
            main = "Total Annual PM2.5 in Baltimore Ciy, MD (All Sources)", beside = FALSE,
            legend.text = c("POINT", "ROAD", "NON-ROAD", "NON-POINT"))
